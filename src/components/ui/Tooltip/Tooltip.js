...
import transitions from './Tooltip.transitions';
...
function getStyles(props, context, state) {
  ...
  const styles = {
    root: {
      ...
      transition: `${transitions.easeOut('0ms', 'top', '450ms')}, ${transitions.easeOut(
        '450ms',
        'transform',
        '0ms',
    ...
    ripple: {
      ...
      transition: `${transitions.easeOut('0ms', 'width', '450ms')}, ${transitions.easeOut(
        '0ms',
        'height',
        '450ms',
    ...
    rootWhenShown: {
      ...
      transition: `${transitions.easeOut('0ms', 'top', '0ms')}, ${transitions.easeOut(
        '450ms',
        'transform',
        '0ms',
      )}, ${transitions.easeOut('450ms', 'opacity', '0ms')}`,
    ...
    rippleWhenShown: {
      ...
      transition: `${transitions.easeOut('450ms', 'width', '0ms')}, ${transitions.easeOut(
        '450ms',
        'height',
        '0ms',
      )}, ${transitions.easeOut('450ms', 'backgroundColor', '0ms')}`,
...
class Tooltip extends Component {
  ...
  setRippleSize() {
    ...
    const tooltipWidth = parseInt(tooltip.offsetWidth, 10) / (this.props.horizontalPosition === 'center' ? 2 : 1);
  ...
  render() {
    ...
    return (
      ...
      >
        <div ref="ripple" style={Object.assign(styles.ripple, this.props.show && styles.rippleWhenShown)} />
